        ...
        <div class="col-md-8 offset-md-2">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Write a Review for <?php echo $course['title']; ?></h4>
                </div>
                <div class="card-body">
                    ...
                    <?php echo form_open('review/create/' . $course['id']); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="review" id="review" class="form-control" rows="6" placeholder="Share your experience with this course..."><?php echo set_value('review'); ?></textarea>
